...
urlpatterns = patterns('',
        ...
        url(r'^Login/user_GroupListNow/HistoryMessasge/(\d{1,2})/$', views.History, name='HistoryMessage'),
        url(r'^Login/user_GroupListNow/search/(\d{1,2})',views.SearchMessage,name='SearchMessage'),
